...
<template>
  <div class="flex flex-col gap-4 md:flex-row">
    ...
    <div class="min-w-0 flex-1">
      <div class="rounded-lg border border-gray-100 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
        <BasicTable
          :columns="fileColumns"
          :api="fetchFileList"
          :params="tableParams"
    ...
    >
      <template #extra>
        <span class="text-xs text-gray-400 dark:text-gray-500"> 支持分片、断点续传、暂停/继续 </span>
      </template>
