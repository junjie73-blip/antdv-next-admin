...
/** 外层容器：小屏上下堆叠，大屏左右分栏 */
export const containerClassName = cn('flex flex-col gap-4 lg:flex-row', 'min-h-[calc(100vh-120px)]')
...
export const cardFooterClassName = cn('shrink-0 border-t border-gray-100 px-4 py-3', 'dark:border-gray-800')
...
export const typeItemNameClassName = cn('truncate text-sm font-medium', 'text-gray-800 dark:text-gray-100')

export const typeItemCodeClassName = cn('mt-0.5 truncate text-xs', 'text-gray-400 dark:text-gray-500')
