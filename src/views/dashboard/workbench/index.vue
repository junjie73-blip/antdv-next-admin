  ...
  <div class="p-8 space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">欢迎回来，这是您的系统概览</p>
      </div>
    ...
    <div class="grid grid-cols-4 gap-4">
      <div v-for="stat in statCards" :key="stat.label" :class="cardClassName">
        <div class="flex items-start gap-4">
          <div
            class="w-11 h-11 rounded-lg bg-ant-primary/10 flex items-center justify-center flex-shrink-0"
          >
            <Icon :icon="stat.icon" :width="22" class="text-ant-primary" />
          </div>
          <div class="flex-1 min-w-0">
            <p
              class="text-2xl font-bold text-gray-800 dark:text-white tracking-tight leading-tight tabular-nums"
            >
              {{ stat.value }}
            </p>
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div :class="cardClassName">
        <h3 class="text-base font-semibold text-gray-800 dark:text-gray-200 mb-4">快捷操作</h3>
        <div class="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div class="min-w-0">
              <p
                class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-ant-primary transition-colors"
              >
                {{ action.title }}
              </p>
      ...
      <!-- 最近动态 -->
      <div :class="cardClassName">
        <h3 class="text-base font-semibold text-gray-800 dark:text-gray-200 mb-4">最近动态</h3>
        <div class="space-y-3">
          <div
