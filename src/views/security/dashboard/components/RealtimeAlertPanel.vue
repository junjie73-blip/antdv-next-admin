  ...
  >
    ...
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center gap-2">
        <h3 class="text-base font-semibold text-gray-800 dark:text-white">实时告警</h3>
        <!-- 脉冲指示灯 -->
      ...
      <a-button size="small" type="link" @click="alerts = []"> 清空已读 </a-button>
    </div>
        ...
        <div class="space-y-2.5">
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <!-- 操作按钮 -->
              <div v-if="isHighPriority(alert.level)" class="flex items-center gap-2 mt-2">
                <a-button
