  ...
  >
    ...
    <div class="flex items-center justify-between mb-4">
      <div>
        ...
        <p class="text-xs text-gray-400 mt-0.5">近期安全事件追踪</p>
      </div>
      <a-badge
    ...
    <div :class="filterBarClassName">
      ...
      <div class="flex items-center gap-1">
        <a-tag
          ...
          :class="tagClassName"
          :color="
            activeStatus === opt.value ? (opt.value === 'pending' ? 'red' : 'green') : undefined
          "
    ...
    <PerfectScrollbar class="max-h-[420px] pr-1">
      <a-spin :spinning="loading">
        <a-timeline v-if="filteredEvents.length > 0" mode="left" class="mt-2">
          ...
          >
            <div
              class="group flex items-start gap-3 py-2 px-2 -ml-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
            >
              <!-- 图标 -->
              <div
