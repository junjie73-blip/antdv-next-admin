...
<template>
  <!-- 大屏容器 -->
  <PerfectScrollbar id="screen-container" class="w-screen h-screen bg-[#0a0e27] text-white">
    <div id="screen-content" class="h-full flex flex-col">
      ...
      <div class="flex-1 min-h-0 grid grid-cols-12 grid-rows-[1fr_auto] gap-3 p-3">
        ...
        <div class="col-span-12 row-start-1 grid grid-cols-12 gap-3 min-h-0">
            ...
            >
              <PerfectScrollbar :options="psOptions" class="h-full relative">
                <div class="space-y-2 pr-1">
                  ...
                  >
                    <div
                      class="w-7 h-7 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-[10px] font-bold shrink-0"
                    >
                      {{ user.name[0] }}
                    </div>
                ...
                <div class="flex items-center gap-3 mt-2 px-1 text-[11px]">
                  ...
                  <div class="flex items-center gap-1.5 ml-auto">
                    ...
                    <span
                      ...
                      :class="[
                        latencyStats.availability >= 99.9 ? 'text-emerald-400' : 'text-amber-400',
                      ]"
                ...
                <PerfectScrollbar :options="psOptions" class="h-full relative">
                  <div class="space-y-1.5 pr-1">
                    ...
                    >
                      ...
                      <span :class="eventLevelText(evt.level)" class="shrink-0">{{
          ...
          <div class="col-span-3 flex flex-col gap-3 h-full min-h-0">
            ...
            <ScreenCard
              title="地区用户分布 TOP9"
              class="flex-[1.5] flex flex-col min-h-0"
              body-class="flex-1 min-h-0"
            >
        ...
        <!-- 安全威胁态势（底部行） -->
        <div
          class="col-span-12 row-start-2 h-[180px] grid grid-cols-12 gap-3 shrink-0 overflow-hidden"
        >
          <!-- 攻击来源 TOP5 -->
      ...
      <!-- 底部信息栏 -->
      <div
        class="h-6 bg-blue-950/80 border-t border-blue-500/10 flex items-center justify-center text-[10px] text-blue-300/30"
      >
        <span
          >数据刷新于 {{ new Date().toLocaleString("zh-CN") }} &nbsp;|&nbsp; Antdv Next Admin
          Security Monitor &nbsp;|&nbsp; v1.0.0</span
        >
      </div>
    </div>
  </PerfectScrollbar>
