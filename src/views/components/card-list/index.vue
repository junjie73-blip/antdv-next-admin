...
:class="statCardClassName">
          ...
          <p :class="statValueClassName">
            {{ stat.value }}
          </p>
          <p :class="statLabelClassName">
            {{ stat.title }}
          </p>
        </div>
      </div>
...
:variant="borderless">
      ...
      <div :class="grid3ColClassName">
        ...
        >
          <div
            :class="cn(hoverCoverClassName, `bg-gradient-to-br ${getCoverGradient(index + 2)}`)"
          />
          <h4 :class="hoverTitleClassName">
            {{ product.name }}
          </h4>
          <p :class="hoverDescClassName">
            {{ product.description }}
          </p>
        </div>
      </div>
        ...
        <div :class="grid3ColClassName">
          ...
          >
            <div class="flex items-start gap-3">
              <div
                :class="
                  cn(filterCardCoverClassName, `bg-gradient-to-br ${getCoverGradient(index)}`)
                "
              />
              <div class="min-w-0 flex-1">
                ...
                <p :class="filterCardDescClassName">
                  {{ product.description }}
                </p>
      ...
      <div :class="masonryClassName">
        ...
        >
          ...
          <div :class="masonryContentClassName">
            <h4 :class="masonryTitleClassName">
              {{ product.name }}
            </h4>
            <p :class="masonryDescClassName">
              {{ product.description }}
            </p>
