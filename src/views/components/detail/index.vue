...
title="工作信息">
    ...
    <a-card title="响应式列">
      ...
      <div class="mb-4 flex gap-2">
        <a-button :type="columnCount === 1 ? 'primary' : 'default'"
@click="columnCount = 1">
          1列
        </a-button>
        <a-button :type="columnCount === 2 ? 'primary' : 'default'"
@click="columnCount = 2">
          2列
        </a-button>
        <a-button :type="columnCount === 3 ? 'primary' : 'default'"
@click="columnCount = 3">
          3列
        </a-button>
        <a-button :type="columnCount === 4 ? 'primary' : 'default'"
@click="columnCount = 4">
          4列
        </a-button>
      </div>
      <a-descriptions :column="columnCount"
bordered>
        <a-descriptions-item
          v-for="(value, key) in {
