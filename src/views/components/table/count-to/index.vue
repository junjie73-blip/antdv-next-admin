  ...
  <div :class="containerClassName">
    ...
    <a-card title="前缀后缀" variant="borderless">
      ...
      <div :class="decimalGridClassName">
        <div
          :class="
            prefixCardClassName(
              'bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border-red-100 dark:border-red-800',
            )
          "
        >
    ...
    <a-card title="正负数展示" variant="borderless">
      ...
      <div :class="decimalGridClassName">
        ...
        <div
          :class="
            signCardClassName('bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800')
          "
        >
        ...
        <div
          :class="
            signCardClassName('bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800')
          "
        >
