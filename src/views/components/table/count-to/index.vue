...
// 基础用法 - 数字展示区域
const numberCardClassName = cn('flex flex-col items-center p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg')
...
<template>
  <div :class="containerClassName">
    ...
    <div :class="pageHeaderClassName">
      <h2 :class="pageTitleClassName">CountTo 数字动画组件</h2>
      <p :class="pageDescClassName">展示数字滚动动画的各种用法与配置选项</p>
    </div>
    ...
    <a-card title="基础用法" variant="borderless">
      ...
      <div :class="numberCardClassName">
        ...
        <CountTo :start-val="0" :end-val="2024" :duration="2000" :class="cn(numberValueClassName, 'text-blue-600')" />
      </div>
    </a-card>
    ...
    <a-card title="前缀后缀" variant="borderless">
      ...
      <div :class="decimalGridClassName">
        <div
          :class="
            prefixCardClassName(
              'border-red-100 bg-gradient-to-br from-red-50 to-orange-50 dark:border-red-800 dark:from-red-900/20 dark:to-orange-900/20',
            )
          "
        >
        ...
        <div
          :class="
            prefixCardClassName(
              'border-green-100 bg-gradient-to-br from-green-50 to-emerald-50 dark:border-green-800 dark:from-green-900/20 dark:to-emerald-900/20',
            )
          "
        >
        ...
        <div
          :class="
            prefixCardClassName(
              'border-blue-100 bg-gradient-to-br from-blue-50 to-cyan-50 dark:border-blue-800 dark:from-blue-900/20 dark:to-cyan-900/20',
            )
          "
        >
          <span :class="numberLabelClassName">人数 (人)</span>
          <CountTo :start-val="0" :end-val="12580" suffix="人" :class="cn(numberValueClassName, 'text-blue-600')" />
        </div>
        <div
          :class="
            prefixCardClassName(
              'border-purple-100 bg-gradient-to-br from-purple-50 to-pink-50 dark:border-purple-800 dark:from-purple-900/20 dark:to-pink-900/20',
            )
          "
        >
    ...
    <a-card title="千分位分隔符" variant="borderless">
      ...
      <div :class="separatorGridClassName">
        <div :class="numberCardClassName">
          ...
          <CountTo :start-val="0" :end-val="12345" separator="," :class="cn(numberValueClassName, 'text-blue-600')" />
        </div>
        <div :class="numberCardClassName">
    ...
    <a-card title="正负数展示" variant="borderless">
      ...
      <div :class="decimalGridClassName">
        <div :class="signCardClassName('border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/20')">
          <span :class="signLabelClassName">正增长 📈</span>
          <CountTo :start-val="0" :end-val="5678" :class="cn(numberValueClassName, 'text-green-600')" />
          <span :class="cn(signChangeClassName, 'text-green-500')">+12.5%</span>
        </div>
        <div :class="signCardClassName('border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20')">
          <span :class="signLabelClassName">负增长 📉</span>
          <CountTo :start-val="0" :end-val="-2345" :class="cn(numberValueClassName, 'text-red-600')" />
          <span :class="cn(signChangeClassName, 'text-red-500')">-8.3%</span>
        </div>
        <div :class="signCardClassName('border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20')">
          <span :class="signLabelClassName">大额正数 💪</span>
          <CountTo :start-val="0" :end-val="99999" :class="cn(numberValueClassName, 'text-blue-600')" />
          <span :class="cn(signChangeClassName, 'text-ant-primary')">+156.8%</span>
        </div>
        <div :class="signCardClassName('border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-900/20')">
          <span :class="signLabelClassName">亏损 ⚠️</span>
          <CountTo :start-val="0" :end-val="-8888" :class="cn(numberValueClassName, 'text-orange-600')" />
    ...
    <a-card title="数据看板面板" variant="borderless">
      ...
      <div :class="dashboardGridClassName">
        <div v-for="(item, index) in dashboardData" :key="index" :class="dashboardCardClassName(item.bgColor)">
    ...
    <a-card title="动态更新目标值" variant="borderless">
      ...
      <div :class="dynamicContainerClassName">
        ...
        <div :class="buttonGroupClassName">
          <a-button type="primary" size="large" @click="updateDynamicValue"> 🎲 随机生成新数值 </a-button>
          <a-button size="large" @click="resetDynamicCounter"> 🔄 重播动画 </a-button>
        </div>
        <p :class="dynamicTipClassName">点击「随机生成」会改变目标值，CountTo 会检测到 endVal 变化并自动重新播放动画</p>
      </div>
    </a-card>
  </div>
</template>
