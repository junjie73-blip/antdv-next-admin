...
<template>
  <div :class="containerClassName">
    <a-card variant="borderless" title="图片裁剪">
      <p :class="cn('mb-4 text-gray-600 dark:text-gray-400')">
      ...
      <div v-else :class="cropSectionClassName">
        <div :class="cropperPanelClassName">
          ...
          <div :class="previewSectionClassName">
            <div :class="previewTitleClassName">裁剪预览</div>
            <div :class="previewGridClassName">
              <div :class="previewBoxClassName">
                <img v-if="cropResult" :src="cropResult" :class="previewImgClassName" alt="裁剪预览" />
        ...
        <div :class="controlPanelClassName">
          <div :class="controlCardClassName">
            <div :class="controlCardTitleClassName">缩放</div>
          ...
          <div :class="controlCardClassName">
            <div :class="controlCardTitleClassName">裁剪比例</div>
