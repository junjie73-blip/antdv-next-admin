  ...
  <div :class="containerClassName">
    <a-card title="Basic Drawer" variant="borderless">
      <div class="space-y-4">
        ...
        <p class="text-gray-500 dark:text-gray-400 text-sm">Click to open a drawer with form content from the right side</p>
      </div>
    </a-card>
      ...
      <a-tabs v-model:activeKey="activeTab">
        ...
        <a-tab-pane key="tree" tab="Tree View">
          <a-tree
            ...
            @select="onTreeSelect"
          />
          <div v-if="selectedTreeNode" class="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-sm">
    ...
    <BasicDrawer @register="registerBasicDrawer" title="Basic Drawer" @ok="handleDrawerSubmit">
    ...
    <BasicDrawer @register="registerLargeDrawer" title="Large Drawer" :width="800">
      ...
      <a-space wrap>
        ...
        <a-tag color="gold">Tailwind CSS</a-tag>
        <a-tag color="cyan">Vite</a-tag>
        <a-tag color="volcano">Bun</a-tag>
      </a-space>
    </BasicDrawer>

    <BasicDrawer @register="registerNoFooterDrawer" title="No Footer Drawer" :footer="{ show: false }">
      <p class="text-gray-600 dark:text-gray-400">This drawer has no footer buttons. Use the X button or click mask to close.</p>
