...
@click="basicModalMethods?.openModal()"> 打开弹窗 </a-button>
...
variant="borderless">
      <a-space>
        <a-button type="primary"
@click="largeModalMethods?.openModal()"> 打开大尺寸弹窗 </a-button>
      </a-space>
    </a-card>

    <a-card title="无底部按钮弹窗"
variant="borderless">
      <a-space>
        <a-button type="primary"
...
variant="borderless">
      <a-space>
        <a-button type="primary"
@click="contentModalVisible = true"> 打开内容弹窗 </a-button>
        <a-button @click="switchContent"> 切换内容 </a-button>
      </a-space>
    </a-card>

    <BasicModal title="基础弹窗"
