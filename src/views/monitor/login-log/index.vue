...
import { loginLogActionColumn, loginLogColumns, loginLogPagination, loginLogRowKey, loginLogScroll } from './columns'
        ...
        >
          ...
          <template #action="{ record }">
            <div :class="actionClassName">
              <a-button type="link" :class="btnClassName" @click="() => handleView(record as LoginLogRecord)">
