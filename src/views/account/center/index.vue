              ...
              >
                ...
                >
                  <div class="flex items-center gap-3">
                    <div
                      class="w-9 h-9 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500"
                    >
        ...
        <a-tab-pane key="activity" tab="活动日志">
          <a-timeline>
            <a-timeline-item v-for="log in activityLogs" :key="log.time">
              <template #dot>
                <div
                  class="w-2.5 h-2.5 rounded-full bg-blue-500 ring-4 ring-blue-100 dark:ring-blue-900/30"
                />
              </template>
              <div class="ml-1">
