...
<template>
  <div :class="containerClassName">
    ...
    <div class="mb-4 flex items-center gap-4">
      ...
      <a-dropdown :menu="{ items: COMMON_BUTTONS }" :trigger="['click']" arrow @menu-click="handleCommonSelect">
        <a-button>
          常见按钮
    ...
    <!-- 新增/编辑抽屉 -->
    <BasicDrawer :title="isEditing ? '编辑按钮' : '新增按钮'" :width="520" @register="drawerRegister" @ok="handleSave">
      <BasicForm
        :schemas="formSchemas"
        :label-width="100"
