...
const detailSchemas: DescriptionItem[] = [
  ...
  { field: "operName", label: "操作人" },
  {
    ...
    label: "操作类型",
    render: (value) => (
      <a-tag color={operTypeColorMap[value as string] || "default"}>{value}</a-tag>
    ),
  },
          ...
          <template #cell-status="{ record }">
            <a-tag :color="statusColorMap[record.status] || 'default'">
              <span class="inline-flex items-center gap-1">
                <Icon
                  :icon="record.status === 0 ? 'carbon:checkmark-outline' : 'carbon:close-outline'"
                />
      ...
      <div v-if="viewingRecord" class="relative pl-6">
        ...
        <div class="space-y-6">
          <div class="relative pb-6">
            <div
              class="absolute left-[-23px] top-[2px] w-3 h-3 rounded-full border-2 border-green-500 bg-white dark:bg-gray-900 z-[1]"
            />
          ...
          <div class="relative pb-6">
            <div
              class="absolute left-[-23px] top-[2px] w-3 h-3 rounded-full border-2 border-ant-primary bg-white dark:bg-gray-900 z-[1]"
            />
          ...
          <div class="relative pb-6">
            ...
            <div class="text-sm">
              <a-tag :color="operTypeColorMap[viewingRecord.operType] || 'default'">{{
          ...
          <div class="relative pb-6">
            <div
              class="absolute left-[-23px] top-[2px] w-3 h-3 rounded-full border-2 bg-white dark:bg-gray-900 z-[1]"
