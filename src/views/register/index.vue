  ...
  <div :class="containerClassName">
    ...
    <div :class="leftPanelClassName">
      ...
      <div class="relative z-10 flex flex-col justify-center px-12 xl:px-20">
        ...
        <div class="mb-12">
          <div
            class="inline-flex items-center gap-3 px-5 py-2.5 bg-white/60 backdrop-blur-md rounded-xl border border-white/80 shadow-lg shadow-slate-900/5"
          >
            <div
        ...
        <div class="space-y-5">
          <div class="flex items-center gap-4 group">
            ...
            <div>
              <h3 class="text-stone-800 font-medium">快速注册</h3>
              <p class="text-stone-500 text-sm">简单几步即可完成注册</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4 group">
            ...
            <div>
              <h3 class="text-stone-800 font-medium">安全加密</h3>
              <p class="text-stone-500 text-sm">数据安全有保障</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4 group">
            ...
            <div>
              <h3 class="text-stone-800 font-medium">免费试用</h3>
              <p class="text-stone-500 text-sm">立即体验所有功能</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div :class="rightPanelClassName">
      <div :class="glassCardClassName">
        ...
        <div class="text-center mb-8">
          <h2 class="text-2xl font-semibold text-stone-800 mb-2">创建账户</h2>
        ...
        >
          ...
          <a-form-item name="agreement">
            ...
            >
              我已阅读并同意
              <a-button type="link" size="small" class="!text-stone-400 hover:!text-stone-600 !p-0">
                《用户协议》
              </a-button>
              和
              <a-button type="link" size="small" class="!text-stone-400 hover:!text-stone-600 !p-0">
