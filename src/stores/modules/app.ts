...
export const useAppStore = defineStore("app", () => {
  ...
  const appSetting = ref<AppSetting>(
    (cache.getItem("appSetting") as AppSetting) || DEFAULT_SETTING,
  );
  /* ---------- 主题 ---------- */
  ...
  const routeMode = toRef(() => appSetting.value.routeMode);
  ...
  const toggles = {
    ...
    showBreadcrumbIcon: () =>
      updateSetting({ showBreadcrumbIcon: !appSetting.value.showBreadcrumbIcon }),
